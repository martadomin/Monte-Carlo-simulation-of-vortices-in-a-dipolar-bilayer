...
function sweep_Rmatch(L::Float64, num_part::Int, nr0_sq::Float64, R_match_vals::Vector{Float64},
    ...
    @threads for idx in eachindex(R_match_vals)
        ...
        energies_vmc, energies_drift_vmc, energies_laplacian_vmc, E_tot, _, E_drift, E_laplacian, _, _ = metropolis(num_part, num_steps, delta, L, R_match, Constants;
        ...
        energies[idx] = avg_energy/nr0_sq_32
        energies_drift[idx] = avg_energy_drift/nr0_sq_32
        energies_laplacian[idx] = avg_energy_laplacian/nr0_sq_32
