...
# Δτ_chosen (from dtau_convergence.jl), num_walkers_vals, num_steps_dmc, quadratic
...
for num_walkers in num_walkers_vals
    ...
    save_run(path, (; num_part, nr0_sq, L, R_opt, Δτ_chosen, num_walkers, num_steps_dmc, quadratic), result)
end
...
# read by final_plot_DMC.jl.
final_path = result_path(stage_dir, "DMC", (N=num_part, nr0sq=nr0_sq))
save_run(final_path, (; num_part, nr0_sq, L, R_opt, Δτ_chosen, num_steps_dmc, quadratic),
