...
println("E_drift/N/(nr0^2)^(3/2) = ", avg_energy_drift/nr0_sq_32)
println("E_laplacian/N/(nr0^2)^(3/2) = ", avg_energy_laplacian/nr0_sq_32)
...
open(results_path, "w") do io
    println(io, "num_part\tnr0_sq\tL\tR_opt\tE_tot\tError\tAcceptance")
    println(io, "$(num_part)\t$(nr0_sq)\t$(L)\t$(R_opt)\t$(E_tot/nr0_sq_32)\t$(sigma/nr0_sq_32)\t$(acceptance_ratio)")
end
