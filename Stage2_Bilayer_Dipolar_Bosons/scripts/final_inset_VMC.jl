# Stage2_Bilayer_Dipolar_Bosons/scripts/final_inset.jl
#
# Inset figure: E/N (+ tail) and ε_b/2 vs h/r₀ — VMC only.
...
pgfplotsx()
p = scatter(h_found, E_corr_vals; yerror=err_vals, label="VMC",
